...
5. 一个三角形有三条线段构成，因此已知亮点，绘制出一条线段
   ...
   <img src="计算机图形学——软光栅渲染器.assets/image-20200112194846169.png" alt="image-20200112194846169" style="zoom:50%;" />

   <img src="计算机图形学——软光栅渲染器.assets/image-20200112194904964.png" alt="image-20200112194904964" style="zoom:50%;" />
